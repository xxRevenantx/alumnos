<div>
    ...
    <form wire:submit.prevent="actualizarGrupo">
        <div class="form-group">
            ...
            <input type="text" wire:model="grupo" class="form-control" id="grupo" placeholder="Ingrese el grupo">
            @error('grupo') <span class="text-danger">{{ $message }}</span> @enderror
        </div>

        <div>

            <x-adminlte-button class="btn-flat" type="submit" label="Actualizar Grupo" theme="primary" icon="fas fa-lg fa-save"/>
            <div wire:loading>
